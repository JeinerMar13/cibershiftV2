	...
	<div id="home" class="parallax">
		<div id="full-width" class="owl-carousel owl-theme home-hero">
			<div class="text-center item slider-01 display-table overlay">
				<div class="display-table-cell">
					<div class="big-tagline text-center">
						<h2><strong>CYBER SHIFT</h2>
						<p class="lead">VIVE NUEVAS EXPERIENCIAS USANDO NUESTRO APLICATIVO CON
							<br> RESPECTO AL AREA DE LA AMINISTRACION Y ORGANIZACION EN LA BARBERIAS !</p>
						
						<a href="http://localhost/CIBERSHIFT/public/contact" class="btn btn-light btn-radius btn-brd grd1 effect-1 butn">resgistrar</a>
					</div>
				</div>
			...
			<div class="text-center item slider-02 display-table overlay">
				<div class="display-table-cell">
					<div class="big-tagline text-center">
						<h2><strong>INGRESA A UN NUEVO SISTEMA </h2>
						<p class="lead">EN EL CUAL PODRAS OBSERVAR LOS CORTES DE CABELLOS MAS RELAVANTES
							<BR></BR>
						</p>
						<a href="http://localhost/CIBERSHIFT/public/appointment " class="btn btn-light btn-radius btn-brd grd1 effect-1 butn">cita </a>
					</div>
				</div>
			</div>
				...
				<div class="row align-items-center">
					<div class="col-md-6 text-left">
						<div class="message-box">
							<h4>About</h4>
							<h2>BIENVENIDO A CYBER SHIFT </h2>
							<p class="lead">En esta pagina usted como cliente se vera obligado a vivir nuevas experiencias relacionadas con la administracion en
							el area de la barberia.</p>

							<p>  </p>

							<a href="https://drive.google.com/file/d/10F9YSxIQfc3uFDrnedPZhw4L8CaDxWg9/view?usp=share_link" data-scroll class="btn btn-light btn-radius btn-brd grd1 effect-1">CONOCE MAS ACERCA DE NUESTRA PAGINA</a>
						</div><!-- end messagebox -->
					</div><!-- end col -->
					<div class="col-md-6 text-center">
						<div class="right-box">
							<img id="img2" class="img-fluid" src="images/jeiner.....png" alt="" />
						</div>
					</div><!-- end col -->
				</div><!-- end row -->
						...
						<div class="testi-carousel owl-carousel owl-theme">                                
							<div class="testimonial clearfix">
								<div class="testi-meta">
									...
									<h4>Jaime Pacheco<small>-Ingeniero en sistemas </small></h4>
								</div>
								<div class="desc">
									<h3>BASE DE DATOS!</h3>
									<p class="lead"></p>
							...
							<div class="testimonial clearfix">
								<div class="testi-meta">
									...
									<img src="" alt="" class="">
									<h4>Yorilis Algarín
										<small>- Ingeniera en sistemas</small></h4>
								</div>
								<div class="desc">
							...
							<div class="testimonial clearfix">
								<div class="testi-meta">
									<i class="fa fa-quote-right"></i>
									<img src="" alt="" class="img-responsive alignright">
									<h4>Wenceslao Fontalvo <small>-Ingeniero en sistemas</small></h4>
								</div>
								<div class="desc">
							...
							<div class="testimonial clearfix">
								<div class="testi-meta">
									<i class="fa fa-quote-right"></i>
									<img src="" alt="" class="img-responsive alignright">
									<h4>Jeiner Martinez<small>- Ingeniero en sistemas</small></h4>
								</div>
								<div class="desc">
									<h3> Great & Talented Team!</h3>
									<p class="lead">. </p>
