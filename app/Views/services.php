						...
						<div class="testi-carousel owl-carousel owl-theme">                                
							<div class="testimonial clearfix">
								<div class="testi-meta">
									...
									<h4>Jaime pacheco <small>- ingeniero en sistema</small></h4>
								</div>
								<div class="desc">
									<h3>BASE DE DATOS!</h3>
									<p class="lead"> </p>
							...
							<div class="testimonial clearfix">
								<div class="testi-meta">
									<i class="fa fa-quote-right"></i>
									<img src="" alt="" class="img-responsive alignright">
									<h4>wenzelao Fontalvo<small>- ingeniero en sistemas </small></h4>
								</div>
								<div class="desc">
							...
							<div class="testimonial clearfix">
								<div class="testi-meta">
									<i class="fa fa-quote-right"></i>
									<img src="" alt="" class="img-responsive alignright">
									<h4>Yorilis Algarín <small>- ingeniera en sistema</small></h4>
								</div>
								<div class="desc">
